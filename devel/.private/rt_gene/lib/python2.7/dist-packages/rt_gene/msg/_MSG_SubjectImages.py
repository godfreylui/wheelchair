...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.subject_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.face_img.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.face_img.encoding = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.right_eye_img.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.right_eye_img.encoding = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.left_eye_img.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.left_eye_img.encoding = str[start:end].decode('utf-8')
      else:
